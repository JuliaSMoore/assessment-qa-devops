...
const drawFive = () => {
    axios.get('http://3.144.175.54/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://3.144.175.54/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://3.144.175.54/api/player')
...
const getAllBots = () => {
    axios.get('http://3.144.175.54/api/robots')
        .then(({data}) => {
